...
<body>
  ...
  <!-- ======= Top Bar ======= -->
<!-- Modify the topbar section in your HTML like this -->
...
<section id="topbar" class="d-flex align-items-center">
  <div class="container d-flex justify-content-center justify-content-md-between">
    ...
    <div class="social-links d-none d-md-flex align-items-center">
      ...
      <a href="login.php" class="member's"><i class="fa fa-user ms-2"></i> Member's Portal</a>
    </div>
  </div>
</section>
    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li class="cl-effect-4">
                ...
                <li class="cl-effect-4">
                  <a href="index.php"><span>Products &amp; Services</span></a>
                </li>                          
                <li class="cl-effect-4">
                  <a href="index.php"><span>Allied Businesses</span></a>
                </li>
                <li class="cl-effect-4">
                  <a href="index.php"><span>Membership</span></a>
                </li>
                <li class="cl-effect-4">
                  <a href="index.php"><span>Branches</span></a>
                </li>
                <li class="cl-effect-4">
                  <a href="index.php"><span>FAQ</span></a>
                </li> 
  ...
  <div class="hero-container">
    <div id="" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
          ...
          <!-- Slide 1 -->
          <div class="carousel-item active" style="background-image: url(img/dashboard-slide.png)">
...
<div class="col-lg-9 col-md-9 col-sm-12 mx-auto">
    <div class="card">
        <img src="img/SocialMedia-Banner.jpg" class="card-img-top " alt="Big Picture">
    </div>
</div>
<br>
<br>
